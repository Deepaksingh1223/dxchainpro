...
const WALLETS = [
  ...
  },
  {
    ...
    popular: true,
    img: "https://seeklogo.com/images/W/walletconnect-logo-EE83B50C97-seeklogo.com.png",
  },
  {
    id: "coinbase",
    ...
    <>
      <style>{`
        ...
        .dcp-tab-active {
          background: #fff;
          color: #00b894;
          box-shadow: 0 1px 6px rgba(0,184,148,0.18);
        ...
        .dcp-modal-footer { border-top: 1px solid #edf7f3; padding: 11px 24px; display: flex; align-items: center; justify-content: center; gap: 14px; flex-wrap: wrap; }
          ...
          <div className="dcp-body">
            ...
            {activeTab === "register" && (
              <div>
                ...
                <button className="dcp-btn-wallet-alt" onClick={() => setActiveTab("wallet")}>
